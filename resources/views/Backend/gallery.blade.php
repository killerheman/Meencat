            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        <form class="form-material" action="{{ route('backend.savegallery') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-5">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-default">
                                        <button class="btn btn-primary btn-round waves-effect waves-light" type="submit" name="save" class="bg-danger">Save</button>
                                    </div>
                                </div>
                        </form>
                    </div>
